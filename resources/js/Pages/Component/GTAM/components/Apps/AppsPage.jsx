...
//         title: "GoldTiger Reports System",
//         description:
//             "In publishing and graphic design, Lorem ipsum is a placeholder text",
//         color1: "teal-600",
//         color2: "from-gtrs1",
...
//         name: "GTMS",
//         icon: HomeIcon,
//         title: "GoldTiger Management System",
//         description:
//             "In publishing and graphic design, Lorem ipsum is a placeholder text",
//         color1: "teal-600",
//         color2: "from-gtms1",
...
//     },
// ];
export default function AppsPage({ activeIndex, setActiveIndex,setApplication,apps }) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-4 my-8 gap-x-10 gap-y-8">
            <div
            ...
            {apps?.length>0? apps.map((app) => (
                <div
                    className={`bg-${app.Colors[0].ColorName} bg-opacity-5 rounded-xl shadow-md p-5 h-[18rem] hover:cursor-pointer`}
                    onClick={()=>{GoAppDetails(app)}}
                >
                    <div className="flex flex-row gap-x-6 items-center">
                        <div
                            className={`bg-gradient-to-b  from-${app.Colors[0].ColorName} to-${app.Colors[1].ColorName} rounded-3xl w-auto p-5`}
                        >
                            <img src={`AppLogo/${app.AppPic}`} alt="" className="h-10 w-10" />
                        </div>
                    ...
                    <div className="py-4">
                        <h1 className="font-bold text-dark">{app.AppName}</h1>
                        <p className="mt-2">{app.AppDesc}</p>
                    </div>
                </div>
            )):null}
        </div>
